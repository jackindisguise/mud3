...
Character migrations use `dungeonVersion` from `package.json`, which is separate from the application `version`. This allows character data migrations to be versioned independently from application releases.
