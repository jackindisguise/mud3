/**
 * Dungeon Migration System Entry Point
 *
 * This file imports all dungeon migrations to register them.
 * Add new migration files here to make them available.
 */

// Import migrations (they self-register via side effects)
//import "./v1.0.0-to-v1.1.1.js";

// Export public API
export { migrateDungeonData } from "./runner.js";
