 ...
 *
 * Sets the version field for old equipment files that don't have a version.
...
registerMigration({
	from: "1.0.0",
	to: "1.0.1",
	description: "Added version field to equipment objects",
	migrate: (
		data: SerializedEquipment & { version?: string }
	): SerializedEquipment & { version?: string } => {
