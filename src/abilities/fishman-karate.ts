/**
 * Fishman Karate ability - A martial art of the fishmen.
 *
 * @example
 * ```
 * fishman karate <target>
 * ```
 */
...
export const ABILITY_ID = "fishman-karate";

export const ability: Ability = {
	id: ABILITY_ID,
	name: "Fishman Karate",
	description: "Execute a powerful fishman karate technique.",
...
export const command: CommandObject = {
	pattern: "'fishman karate'~ <target:mob?>",
	aliases: ["fmk <target:mob?>"],
	...
	execute(context: CommandContext, args: Map<string, any>): void {
		...
		act(
			{
				user: `You execute a powerful fishman karate technique on {target}!`,
				target: `{User} executes a powerful fishman karate technique on you!`,
				room: `{User} executes a powerful fishman karate technique on {target}!`,
			},
			{
				user: actor,
				target: target,
