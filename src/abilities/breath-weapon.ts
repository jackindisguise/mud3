/**
 * Breath Weapon ability - A powerful breath attack.
 *
 * @example
 * ```
 * breath weapon <target>
 * ```
 */
...
export const ABILITY_ID = "breath-weapon";

export const ability: Ability = {
	id: ABILITY_ID,
	name: "Breath Weapon",
	description: "Unleash a devastating breath attack against your enemies.",
...
export const command: CommandObject = {
	pattern: "'breath weapon'~ <target:mob?>",
	...
	execute(context: CommandContext, args: Map<string, any>): void {
		...
		act(
			{
				user: `You unleash a devastating breath attack at {target}!`,
				target: `{User} unleashes a devastating breath attack at you!`,
				room: `{User} unleashes a devastating breath attack at {target}!`,
			},
			{
				user: actor,
				target: target,
