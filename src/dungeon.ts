...
> = Object.freeze({
	...
	vitality: { strength: 1.2 },
	defense: { strength: 0.8 },
	critRate: { agility: 0.3 },
	avoidance: { agility: 1.1 },
	accuracy: { agility: 1 },
	endurance: { agility: 0.9 },
	spellPower: { intelligence: 1.6 },
	wisdom: { intelligence: 1.2 },
	resilience: { intelligence: 0.8 },
});
...
export class Mob extends Movable {
	...
	public set health(value: number) {
		this._health = clampNumber(Number(value), 0, this.maxHealth);
	}
	...
	public set mana(value: number) {
		this._mana = clampNumber(Number(value), 0, this.maxMana);
	}
	...
	public set exhaustion(value: number) {
		this._exhaustion = clampNumber(Number(value), 0, MAX_EXHAUSTION);
	}
